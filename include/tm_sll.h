...
typedef struct _$_tm_sll_node
{
void *ptr;
struct _$_tm_sll_node *next;
}SinglyLinkedListNode;

 

typedef struct _$_tm_sll

{

struct _$_tm_sll_node *start;

struct _$_tm_sll_node *end;
...
typedef struct _$_tm_sll_iterator
...
void * getFromSinglyLinkedList(SinglyLinkedList *singlyLinkedList,int index,bool *suucess);
